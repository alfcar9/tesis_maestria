  ...
  for(k in (num_iter-1):1){ # ... las restantes aristas
    ...
    if(m1 < Inf & m2 < Inf){
      ...
      if(bool1 & bool2){
        print(i)
        print(num_iter)
        print(c(city11, city12, city21, city22))
      }
    }
...
g1 <- TSP_plot(cities_pos_df, path_min_noswap, path_min_noswap) +  ggtitle("Greedy")  + labs (x = total_cost_min_noswap, y = "")
g2 <- TSP_plot(cities_pos_df, paths[plot_index,], paths[plot_index,]) +  ggtitle("Greedy")  + labs (x = costs_cycles[plot_index], y = "")
#g2 <- TSP_plot(cities_pos_df, path_min_swap, path_min_noswap) +  ggtitle("Swapping")  + labs (x = total_cost_min_swap, y = "")
